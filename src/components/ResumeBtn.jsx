...
export default function ResumeBtn() {
  ...
  return (
    ...
    <a
      ...
      className="clickable fixed z-30 bottom-0.5 right-6 transform -translate-y-1/2 flex items-center p-1 rounded-2xl shadow-xl  bg-light-btn text-light-btnTxt dark:bg-dark-btn dark:text-dark-btnTxt group hover:rounded-md hover-anim"
    >
